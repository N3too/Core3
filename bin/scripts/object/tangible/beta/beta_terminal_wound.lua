...
object_tangible_beta_beta_terminal_wound = object_tangible_beta_shared_beta_terminal_wound:new {
	...
	itemList = {
			...
			"Expensive Character Medical Buff (12,000 Credits)", "expensive_enhance_character_body",
			"Expensive Character Mind Buff (5,000 Credits)", "expensive_enhance_character_mind",
