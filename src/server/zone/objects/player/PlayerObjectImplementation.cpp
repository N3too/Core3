...
void PlayerObjectImplementation::notifyOnline() {
	...
	*luaOnPlayerLoggedIn << playerCreature;
	...
	playerCreature->sendExecuteConsoleCommand("/chatRoom join SWG.unleashed.General1");
	playerCreature->sendExecuteConsoleCommand("/chatRoom join SWG.unleashed.PvP1");
